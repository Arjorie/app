...
class _CompleteOrdersState extends State<CompleteOrders> {
  ...
  /* Get complete orders count by employee */
      ...
      child: Scaffold(
        body: Stack(
          children: [
            CustomScrollView(
              slivers: <Widget>[
                CustomAppBar(title: 'Complete Orders', backEnabled: true),
                CustomListTitle(text: 'List of of all complete orders'),
                SliverList(
