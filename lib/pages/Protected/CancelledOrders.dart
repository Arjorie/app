      ...
      child: Scaffold(
        body: Stack(
          children: [
            CustomScrollView(
              slivers: <Widget>[
                CustomAppBar(title: 'Cancelled Orders', backEnabled: true),
                CustomListTitle(text: 'List of of all cancelled orders'),
                SliverList(
                  delegate: SliverChildBuilderDelegate(
                    ...
                    childCount: cancelledOrders.length == 0
                        ? 1
